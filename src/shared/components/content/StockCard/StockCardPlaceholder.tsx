...
import { SStockCard, SStockCardBody } from "./StockCard.styles";

export interface IStockCardPlaceholderProps {
  className?: string;
}

export const StockCardPlaceholder: React.FC<
  IStockCardPlaceholderProps
> = () => {
  const isTwoLines = useRef<boolean>(Math.random() < 0.5);

  return (
    <SStockCard data-plum-ui="listing-card-placeholder">
