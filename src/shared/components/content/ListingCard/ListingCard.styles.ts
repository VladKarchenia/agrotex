...
export const SListingCard = styled("div", {
  height: "100%",
  minWidth: 150,
  display: "flex",
...
export const SListingCardImageContainer = styled("div", {
  height: 0,
  overflow: "hidden",
  paddingTop: "125%",
  pointerEvents: "none",
...
export const SListingCardImage = styled("div", {
  position: "absolute",
  height: "100%",
  width: "100%",
  top: 0,
...
export const SListingCardBody = styled("div", {
  display: "flex",
  flexDirection: "column",
  flexGrow: 1,
...
export const SListingCardLink = styled("a", {
  display: "flex",
  flexDirection: "column",
  height: "100%",
  textDecoration: "none",
